...
<!--
  Adapted from the OpenHands Extensions project.
  Source: https://github.com/OpenHands/extensions/tree/main/skills/ssh
  Original work Copyright (c) OpenHands contributors.
